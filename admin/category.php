...
<body>
        ...
        <div class="container content">
                ...
                <div class="action">
                        <h1 class="page-title">Create/Edit category</h1>
                        <form method="post" action="<?php echo BASE_URL . 'admin/category.php'; ?>" >
                                                ...
                                                <tr>
                                                        ...
                                                        <td>
                                                                <a class="fa fa-pencil btn edit"
                                                                        href="category.php?edit-category=<?php echo $category['id'] ?>">
                                                                </a>
                                                        </td>
                                                        <td>
                                                                <a class="fa fa-trash btn delete"                                                            
                                                                        href="category.php?delete-category=<?php echo $category['id'] ?>">
                                                                </a>
                                                        </td>
                                                </tr>
                                        <?php endforeach ?>
